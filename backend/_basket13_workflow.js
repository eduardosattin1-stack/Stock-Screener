export const meta = {
  ...
  phases: [ { title: 'DeepDossier', model: 'fable' }, { title: 'CatalystCRO', model: 'fable' }, { title: 'Director', model: 'fable' } ],
}
const NAMES = [{"symbol": "CAPR", "company_name": "Capricor Therapeutics, Inc.", "tier": "ACTIVE", "staging": false, "lane_canon": "bio_convergence", "resolution_driver": "FDA_approval_decision", "super_cluster": "FDA/biotech", "edge_grade": "H", "valuation_method": "binary_prob", "computed_rr": null, "ev_pct": 0.9805, "payoff": 2.62, "win_prob": 0.7, "fair_value_target": 52.0, "downside_floor": 7.0, "live_price": 19.44, "dated_milestone": "2026-07-29", "days_to_milestone": 8, "instrument": "CAPR equity (event-driven; options attractive for defined-risk binary exposure)", "valuation_asof": "2026-06-08", "score": 8.0}]
const MODEL = 'fable'
const HELD = {"names": [{"symbol": "FIG", "weight_pct": 5, "driver": "Forced_divest_flow", "super_cluster": "Idiosyncratic", "status": "OPEN"}, {"symbol": "AQST", "weight_pct": 4.5, "driver": "FDA_approval_decision", "super_cluster": "FDA/biotech", "status": "OPEN"}, {"symbol": "WVE", "weight_pct": 3.5, "driver": "FDA_pathway_feedback", "super_cluster": "FDA/biotech", "status": "OPEN"}, {"symbol": "AMLX", "weight_pct": 2, "driver": "FDA_clinical_readout", "super_cluster": "FDA/biotech", "status": "OPEN"}, {"symbol": "AAUC", "weight_pct": 7, "driver": "Foreign_regulator", "super_cluster": "Deal-completion", "status": "OPEN"}, {"symbol": "ZYME", "weight_pct": 2, "driver": "FDA_approval_decision", "super_cluster": "Deal-completion", "status": "OPEN"}, {"symbol": "DDL", "weight_pct": 3, "driver": "Refi_restructuring", "super_cluster": "Idiosyncratic", "status": "OPEN"}, {"symbol": "VIR", "weight_pct": 2, "driver": "FDA_clinical_readout", "super_cluster": "FDA/biotech", "status": "OPEN"}, {"symbol": "OLMA", "weight_pct": 2, "driver": "FDA_clinical_readout", "super_cluster": "FDA/biotech", "status": "OPEN"}, {"symbol": "AVIR", "weight_pct": 2, "driver": "FDA_clinical_readout", "super_cluster": "Idiosyncratic", "status": "OPEN"}], "n_seats": 10, "by_driver": {"Forced_divest_flow": 1, "FDA_approval_decision": 2, "FDA_pathway_feedback": 1, "FDA_clinical_readout": 4, "Foreign_regulator": 1, "Refi_restructuring": 1}, "by_cluster": {"Idiosyncratic": 10.0, "FDA/biotech": 14.0, "Deal-completion": 9.0}, "invested_pct": 33.0}
const WATCHLIST = {"n_on_deck": 7, "names": [{"symbol": "EYPT", "de_prioritized": false, "entry_date": "2026-06-13", "expected_pct": 89.6, "prior_blocked_by": "12-seat count / driver diversity (no fresh dossier this promotion run)"}, {"symbol": "BBIO", "de_prioritized": false, "entry_date": "2026-06-13", "expected_pct": 46.6, "prior_blocked_by": "12-seat count (no fresh dossier this promotion run)"}, {"symbol": "PVLA", "de_prioritized": false, "entry_date": "2026-06-23", "expected_pct": 59.1, "prior_blocked_by": "12-seat count (no fresh dossier this promotion run)"}, {"symbol": "DBVT", "de_prioritized": false, "entry_date": "2026-06-23", "expected_pct": 43.6, "prior_blocked_by": "12-seat count (no fresh dossier this promotion run)"}, {"symbol": "GERN", "de_prioritized": false, "entry_date": "2026-07-02", "expected_pct": 45.7, "prior_blocked_by": "12-seat count (no fresh dossier this promotion run)"}, {"symbol": "CLVT", "de_prioritized": false, "entry_date": "2026-06-13", "expected_pct": null, "prior_blocked_by": "Forced_divest_flow driver (2/2 with FIG held)"}, {"symbol": "MGNI", "de_prioritized": false, "entry_date": "2026-06-23", "expected_pct": 8.0, "prior_blocked_by": "Forced_divest_flow driver (2/2 with FIG held)"}]}
