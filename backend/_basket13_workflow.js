...
const NAMES = [{"symbol": "VIR", "company_name": null, "tier": "on_deck_promotion", "staging": false, "lane_canon": null, "resolution_driver": null, "super_cluster": null, "edge_grade": null, "valuation_method": null, "computed_rr": null, "ev_pct": null, "payoff": null, "win_prob": null, "fair_value_target": null, "downside_floor": null, "live_price": 8.61, "dated_milestone": null, "days_to_milestone": null, "instrument": null, "valuation_asof": "2026-06-13", "score": null, "weekly_diagnosis": {"debate": {"catalyst_status": "PENDING_HARD", "verdict": "B", "conviction": 3, "dated_milestone": "ECLIPSE 1 Phase 3 hepatitis delta topline data expected Q4 2026; VIR-5818 (HER2) Phase 1 dose-escalation data 2H 2026; ECLIPSE 2 and 3 topline Q1 2027.", "age_days": 15.0, "fresh": false}, "skeptic": {"verdict": "CONFIRMED_WITH_CORRECTIONS", "kill_fact": "The catalyst is genuinely LIVE and the Q4-2026 date in the file is CORRECT (a prior skeptic pass wrongly demoted it to Q1 2027 off the stale Nov-3-2025 release; the company's LATER guidance - Jan 12, 2026 IR update and the May 6, 2026 Q1 earnings - both explicitly state ECLIPSE 1 TOPLINE in Q4 2026, with ECLIPSE 2/3 in Q1 2027). The real weakness the file glosses: the pending ECLIPSE 1 readout is a PURE BINARY clinical event with NO contractual payout - no deal-break price, no CVR, no financing backstop. A Phase 3 miss drops the stock toward net cash (~$4.6-4.8/sh), so the claimed ~$5.5 floor is SOFT, not hard. Critically, the largest/most-certain catalyst (the Astellas validation) ALREADY FIRED and re-rated the stock ~133% YTD; the live price ($10.36, prev close $10.03) sits ABOVE the $11.5 base case, so the wide arbitrage spread the funnel was built to capture is substantially CLOSED. Asymmetry survives only as gated pipeline option value, not a live mispriced spread.", "conviction_cap": 38, "age_days": 15.0, "fresh": false}}}]
const MODEL = 'opus'
const HELD = {"names": [{"symbol": "GDOT", "weight_pct": 14, "driver": "Deal_close_generic", "super_cluster": "Deal-completion", "status": "OPEN"}, {"symbol": "UNF", "weight_pct": 8, "driver": "US_antitrust", "super_cluster": "Deal-completion", "status": "OPEN"}, {"symbol": "FIP", "weight_pct": 10, "driver": "Refi_restructuring", "super_cluster": "Idiosyncratic", "status": "OPEN"}, {"symbol": "FIG", "weight_pct": 5, "driver": "Forced_divest_flow", "super_cluster": "Idiosyncratic", "status": "OPEN"}, {"symbol": "BLCO", "weight_pct": 5, "driver": "Forced_divest_flow", "super_cluster": "Idiosyncratic", "status": "OPEN"}, {"symbol": "CELC", "weight_pct": 1.5, "driver": "FDA_clinical_readout", "super_cluster": "FDA/biotech", "status": "OPEN"}, {"symbol": "AQST", "weight_pct": 4.5, "driver": "FDA_approval_decision", "super_cluster": "FDA/biotech", "status": "OPEN"}, {"symbol": "WVE", "weight_pct": 3.5, "driver": "FDA_pathway_feedback", "super_cluster": "FDA/biotech", "status": "OPEN"}, {"symbol": "AMLX", "weight_pct": 2, "driver": "FDA_clinical_readout", "super_cluster": "FDA/biotech", "status": "OPEN"}, {"symbol": "AAUC", "weight_pct": 7, "driver": "Foreign_regulator", "super_cluster": "Deal-completion", "status": "OPEN"}, {"symbol": "FUN", "weight_pct": 4, "driver": "Activist_process", "super_cluster": "Idiosyncratic", "status": "OPEN"}, {"symbol": "ZYME", "weight_pct": 2, "driver": "FDA_approval_decision", "super_cluster": "Deal-completion", "status": "OPEN"}, {"symbol": "DDL", "weight_pct": 3, "driver": "Refi_restructuring", "super_cluster": "Idiosyncratic", "status": "OPEN"}, {"symbol": "LBTYK", "weight_pct": 2.5, "driver": "Spin_index_flow", "super_cluster": "Idiosyncratic", "status": "OPEN"}], "n_seats": 14, "by_driver": {"Deal_close_generic": 1, "US_antitrust": 1, "Refi_restructuring": 2, "Forced_divest_flow": 2, "FDA_clinical_readout": 2, "FDA_approval_decision": 2, "FDA_pathway_feedback": 1, "Foreign_regulator": 1, "Activist_process": 1, "Spin_index_flow": 1}, "by_cluster": {"Deal-completion": 31.0, "Idiosyncratic": 29.5, "FDA/biotech": 11.5}, "invested_pct": 72.0}
const WATCHLIST = {"n_on_deck": 9, "names": [{"symbol": "EYPT", "de_prioritized": false, "entry_date": "2026-06-13", "expected_pct": 89.6, "prior_blocked_by": "FDA_clinical_readout driver 2/2 full (held CELC + AMLX) AND bio_convergence lane 5/5 full"}, {"symbol": "BBIO", "de_prioritized": false, "entry_date": "2026-06-13", "expected_pct": 46.6, "prior_blocked_by": "FDA_clinical_readout driver 2/2 full (held CELC + AMLX) AND bio_convergence lane 5/5 full"}, {"symbol": "VIR", "de_prioritized": false, "entry_date": "2026-06-13", "expected_pct": 61.6, "prior_blocked_by": "bio_convergence lane 5/5 full AND FDA_clinical_readout driver 2/2 full"}, {"symbol": "PVLA", "de_prioritized": false, "entry_date": "2026-06-23", "expected_pct": 59.1, "prior_blocked_by": "bio_convergence lane 5/5 full AND FDA_clinical_readout driver 2/2 full"}, {"symbol": "AVIR", "de_prioritized": false, "entry_date": "2026-06-23", "expected_pct": 57.2, "prior_blocked_by": "bio_convergence lane 5/5 full AND FDA_clinical_readout driver 2/2 full"}, {"symbol": "DBVT", "de_prioritized": false, "entry_date": "2026-06-23", "expected_pct": 43.6, "prior_blocked_by": "FDA_approval_decision driver 2/2 full (held VRDN + AQST) AND bio_convergence lane 5/5 full"}, {"symbol": "CLVT", "de_prioritized": false, "entry_date": "2026-06-13", "expected_pct": null, "prior_blocked_by": "Forced_divest_flow driver 2/2 full (held FIG + BLCO)"}, {"symbol": "MGNI", "de_prioritized": false, "entry_date": "2026-06-23", "expected_pct": 8.0, "prior_blocked_by": "Forced_divest_flow driver 2/2 full (held FIG + BLCO)"}, {"symbol": "GERN", "de_prioritized": false, "entry_date": "2026-07-02", "expected_pct": 45.7, "prior_blocked_by": "FDA_approval_decision driver 2/2 full (held VRDN + AQST) AND bio_convergence lane 5/5 full"}]}
