...
# locked held book (any UNRESOLVED tracker entry): a re-debate ADDS new seats; held names run
# to resolution. The per-driver / per-cluster mix is still computed and shown to the Director
# as CONTEXT (caps all removed 2026-08-11 — see _basket13_inject.py dials), and
# _basket13_inject.py re-validates the combined book's structural gates deterministically.
